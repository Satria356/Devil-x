...
const ftroli = { key: { fromMe: false, "participant": "0@s.whatsapp.net", "remoteJid": "6289523258649-1604595598@g.us" }, "message": { orderMessage: { itemCount: 10, status: 200, thumbnail: fs.readFileSync(`./foto/deff.jpg`), surface: 200, message: `【DEFFBOTZ】`, orderTitle: 'deffpratama', sellerJid: '0@s.whatsapp.net' } }, contextInfo: { "forwardingScore": 999, "isForwarded": true }, sendEphemeral: true }
const spinner = {
    "interval": 0.00000003,
    "frames": [
        "-",
...
const starts = async (deff = new WAConnection()) => {
    ...
    console.log(color(`${spc2}                      [ • CREATOR BOT DEFFBOTZ • ]` ,'cyan'))
console.log(color(`${spc4}                       < ================================================== >`, 'purple'))
console.log(color(`${spc3}                    [•]`, 'aqua'), color(`Hai         : OWNER DEF`, 'yellow'))
console.log(color(`${spc3}                    [•]`, 'aqua'), color(`Bot Version : 2.1.2`, 'yellow'))
console.log(color(`${spc3}                    [•]`, 'aqua'), color(`Status      : Online!`, 'yellow'))
console.log(color(`${spc3}                    [•]`, 'aqua'), color(`Owner       : DEFF`, 'yellow'))
console.log(color(`${spc4}                       < ================================================== >`, 'purple'))
    ...
    buttonMessagee = {
        contentText: `BOT TELAH AKTIF DI NOMOR INI JANGAN LUPA SUBS YT DEFFBOTZZ`,
